"""
@file power_measurement_stream.py
@brief USB Channel Power Measurement — streaming voltage/current monitor.
...
Run:
    python examples/advanced/power_measurement_stream.py
"""
