...
def get_global_channel_info(device_index, local_channel, channels_per_device=4):
    ...
    Args:
        ...
        local_channel (int): Channel number within device (1-4)
        channels_per_device (int): Number of channels per device, default is 4
...
def get_device_and_local_channel(global_channel, channels_per_device=4):
    ...
    """
    global_channel -= 1  # Convert to 0-based
...
def main():
    ...
    channels_per_device = 4  # Number of channels per device
